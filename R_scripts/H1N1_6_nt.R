# Rscript --vanilla H1N1_6_nt.R FILE 
...
# Gene structure
Track_1<-ATrack(start=c(1,21,1431), end=c(20,1430,1458), 
                name ="Gene structure",
...
# Features
Track_3<-ATrack(start=c(375,474,897), end=c(377,476,899),
                name ="Features",
...
# Structure coverage
Structure_coverage<-ATrack(start=c(267), end=c(1427),
